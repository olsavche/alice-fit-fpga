...
set_false_path -from [get_cells {{CH*_shift_reg[*]} {CH*_rc_reg[*]} {ampl_sat_reg[*]} {ampl_low_reg[*]} {gate_time_high_reg[*]} {chans_ena_r_reg[*]} {trig_dis_reg[*]}  chans_block_reg fdd_reg}] -to [get_clocks CLK320]
